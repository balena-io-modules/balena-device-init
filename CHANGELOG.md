...
* Disable automerge for dependency reconfix [Kyle Harding]

## 8.1.9 - 2025-06-06

* Revert "Update dependency reconfix to v1.0.0-v0-1-0-fork-6e4a35edfd299e9302f3791808542e491c7bf6bc" [Otavio Jacobi]

## 8.1.8 - 2025-03-21

* Update dependency etcher-sdk to v9.1.3 [balena-renovate[bot]]

## 8.1.7 - 2025-03-21

* Update dependency reconfix to v1.0.0-v0-1-0-fork-6e4a35edfd299e9302f3791808542e491c7bf6bc [balena-renovate[bot]]

## 8.1.6 - 2025-03-21

* Update dependency etcher-sdk to v9.0.11 [balena-renovate[bot]]
...
* Convert some tests to async await [Thodoris Greasidis]
